...
.settings-page { min-height: 100%; }.settings-page :deep(.config-container), .settings-page :deep(.page-container), .settings-page :deep(.stock-basic-container), .settings-page :deep(.account-management-page) { max-width: none !important; padding: 0 !important; }.settings-page :deep(.config-header), .settings-page :deep(.page-header), .settings-page :deep(.stock-basic-container > .header) { padding: 0 0 20px !important; }.settings-page :deep(.config-header h2::before), .settings-page :deep(.config-header h3::before), .settings-page :deep(.page-title::before), .settings-page :deep(.stock-basic-container > .header h3::before) { display: none; }.settings-page :deep(.table-container) { overflow: auto; }.settings-page :deep(.market-review-page), .settings-page :deep(.analysis-page), .settings-page :deep(.chat-container) { height: auto !important; min-height: 560px; }
</style>
